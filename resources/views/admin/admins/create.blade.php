...
@section('title', __('admins.create_admin'))
...
@section('content_header')
    <div class="row mb-2 align-items-center">
        <div class="col-sm-6 d-flex align-items-center">
            ...
            <h1 class="mb-0">{{ __('admins.create_admin') }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{ __('admins.create_admin') }}</li>
            </ol>
        </div>
    </div>
@stop
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.admins.store') }}">
                ...
                <div class="form-group">
                    <label for="password">{{ __('admins.password') }} <span class="text-danger">*</span></label>
