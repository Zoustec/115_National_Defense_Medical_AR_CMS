...
@section('title', __('cms.create_title', ['resource' => __('cms.learning_unit')]))
...
@section('content_header')
    <div class="d-flex align-items-center mb-2">
        ...
        <h1 class="mb-0">{{ __('cms.create_title', ['resource' => __('cms.learning_unit')]) }}</h1>
    </div>
@stop
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.learning-units.store') }}" enctype="multipart/form-data">
                @csrf
