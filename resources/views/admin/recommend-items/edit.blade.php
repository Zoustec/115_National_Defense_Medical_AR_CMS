...
@section('title', __('cms.edit_title', ['resource' => __('cms.recommend_item')]))
...
@section('content_header')
    <div class="d-flex align-items-center mb-2">
        ...
        <h1 class="mb-0">{{ __('cms.edit_title', ['resource' => __('cms.recommend_item')]) }}</h1>
    </div>
@stop
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.recommend-items.update', $recommendItem) }}">
                @csrf @method('PUT')
